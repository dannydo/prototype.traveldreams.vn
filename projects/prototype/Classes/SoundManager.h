...
enum SoundEffectType
{
	...
	_SET_FLASHCARD_CHOOSE_RIGHT_,
	_SET_FLASHCARD_CHOOSE_WRONG_,

	_SET_ENCOURAGE_NICE_,
	_SET_ENCOURAGE_LOVELY_,
	_SET_ENCOURAGE_BEAUTIFUL_,
	_SET_ENCOURAGE_BRILLIANT_,
	_SET_ENCOURAGE_ARTISTIC_
